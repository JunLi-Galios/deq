...
import models.hyrnn.poincare as pmath
import geoopt
import models.hyrnn as hyrnn
import functools
...
class RNNBase(nn.Module):
    ...
    def forward(self, input):
        ...
        source_input_data = self.embedding(source_input.data.to(device))
        target_input_data = self.embedding(target_input.data.to(device))
        ...
        print('before cell_source')
        
        print('source_input', type(source_input))
        print('target_input', type(target_input))
        print('zero_hidden', type(zero_hidden))
